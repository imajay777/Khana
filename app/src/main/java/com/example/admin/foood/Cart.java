...
import com.example.admin.foood.ViewHolder.CartAdapter;
...
public class Cart extends AppCompatActivity {
    ...
    private void showAlertDialog() {
        ...
        alertDialog.setMessage("Delivery Point:");
        ...
        alertDialog.setIcon(R.drawable.ic_shopping_cart_black_24dp);
                ...
                alertDialog.setPositiveButton("Ok,cool", new DialogInterface.OnClickListener() {
                    @Override
